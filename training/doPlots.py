...
model = models.load_model('model_nFirstNeurons512_nHiddenLayers_13_LearningRate_0.000185577298812_BatchSize_1024.h5')
...
print('TuneP R mean pT[1500,2500]:',np.mean(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_TunePTrack_pt.values)/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values), '+/-', np.std(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_TunePTrack_pt.values)/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values)/np.sqrt(len(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values)))
print('Prediced R mean: ', np.mean(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-model.predict(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)][variablesTrain]).ravel())/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values), '+/-', np.std(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-model.predict(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)][variablesTrain]).ravel())/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values)/np.sqrt(len(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values)))


print('TuneP R std pT[1500,2500]:',np.std(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_TunePTrack_pt.values)/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values))
print('Prediced R std: ', np.std(abs(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values-model.predict(test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)][variablesTrain]).ravel())/test[(test.Muon_Genpt>1500) & (test.Muon_Genpt<2500)].Muon_Genpt.values))



#ptbins = [200, 600, 1000, 1400, 1800, 2200, 2600, 3000]
ptbins = [200, 500, 800, 1100, 1400, 1700, 2000, 2300, 2600, 2900]
...
plt.errorbar(x, Relreco, xerr=ex , linewidth=5, fmt='o')
plt.errorbar(x, Relpred, xerr=ex , linewidth=5, fmt='o')
...
plt.errorbar(x, Biasreco, yerr=eBiasreco, xerr=ex , linewidth=5, fmt='o')
plt.errorbar(x, Biaspred, yerr=eBiaspred, xerr=ex , linewidth=5, fmt='o')
